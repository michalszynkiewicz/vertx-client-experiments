 ...
 */
public class ResponseHttpDataFactory {
    /**
     ...
     */
    private final Map<HttpClientResponse, List<HttpData>> responseFileDeleteMap =
     ...
     */
    public ResponseHttpDataFactory() {
        useDisk = false;
        checkSize = true;
        minSize = MINSIZE;
    }

    public ResponseHttpDataFactory(Charset charset) {
        this();
     ...
     */
    public ResponseHttpDataFactory(boolean useDisk) {
        this.useDisk = useDisk;
        checkSize = false;
    }

    public ResponseHttpDataFactory(boolean useDisk, Charset charset) {
        this(useDisk);
        this.charset = charset;
    }
    /**
     ...
     */
    public ResponseHttpDataFactory(long minSize) {
        useDisk = false;
        checkSize = true;
        this.minSize = minSize;
    }

    public ResponseHttpDataFactory(long minSize, Charset charset) {
        this(minSize);
        this.charset = charset;
    }
    ...
    // mstodo this is actually a download here!
